...
pub const table = table: {
    ...
    const generated = if (@hasDecl(@import("root"), "unicode_tables")) 
        @import("unicode_tables").Tables(Properties)
    else 
        struct {
            pub const stage1 = [_]u16{0};
            pub const stage2 = [_]u16{0};
            pub const stage3 = [_]Properties{Properties{}};
        };
