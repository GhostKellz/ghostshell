...
`$HOME/Library/Application Support/com.ghostkellz.ghostshell/config`.** This is the
...
utility with `log stream --level debug --predicate 'subsystem=="com.ghostkellz.ghostshell"'`.
