# Generated by Powerlevel10k configuration wizard on 2025-05-25 at 15:02 EDT.
...
# angled separators, round heads, round tails, 2 lines, disconnected, no frame, sparse,
...
typeset -g POWERLEVEL9K_FILE_NAME_COLORS=(
 ...
 # typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=18
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=122
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=33
